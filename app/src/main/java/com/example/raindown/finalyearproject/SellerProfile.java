...
public class SellerProfile extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        stuff = (Stuff) bundle.getSerializable("ViewProfile");
        getActivity().setTitle(stuff.getStudentID().getStudentName());
    }
                                                        ...
                                                        public void onResponse(String response) {
                                                            ...
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    ...
                                                                    //pahoMqttClient.subscribe(mqttAndroidClient,stuff.getStudentID().getStudentID(),1);
