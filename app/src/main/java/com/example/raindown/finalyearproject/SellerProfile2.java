...
public class SellerProfile2 extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        subscribe = (Subscribe) bundle.getSerializable("ClickedFollow");
        getActivity().setTitle(subscribe.getSubscribeeID().getStudentName());
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Picasso.with(getActivity()).load(subscribe.getSubscribeeID().getPhoto()).memoryPolicy(MemoryPolicy.NO_CACHE).networkPolicy(NetworkPolicy.NO_CACHE).into(studentPhoto);
        studentName.setText(subscribe.getSubscribeeID().getStudentName());
        studentProgramme.setText(subscribe.getSubscribeeID().getStudentProgramme());
        studentFaculty.setText(subscribe.getSubscribeeID().getStudentFaculty());
        yearOfStudy.setText("Year " + String.valueOf(subscribe.getSubscribeeID().getYearOfStudy()));
        ...
        feedback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundles.putSerializable("GiveFeedback", subscribe.getSubscribeeID());
                            ...
                            new Response.Listener<JSONArray>() {
                                ...
                                public void onResponse(JSONArray response) {
                                    ...
                                    try {
                                        ...
                                        itemSelling.setText("Stuffs Selling : " + String.valueOf(sellerDetailsList.size()) + " items");
                                        populateListView();
                                        checkSubscribe();
                                        if (pDialog.isShowing())
                                            pDialog.dismiss();
            ...
            if (isConnected) {
                if(status.equals("Subscribe")){
                    command = "{\"command\": \"30303530300D\", \"reserve\": \"303030303030303030303030303030303030303030303030\", " +
                            "\"subscribeeID\": " + "\"" + Conversion.asciiToHex(subscribe.getSubscribeeID().getStudentID()) + "\" ," +
                                                        ...
                                                        public void onResponse(String response) {
                                                            ...
                                                            try {
                                                                ...
                                                                if (success.equals("1")) {
                                                                    ...
                                                                    countFollowers2(getActivity(), Constant.serverFile + "countFollowers.php?subscribeeID=" + subscribe.getSubscribeeID().getStudentID());
                                                                    //pahoMqttClient.subscribe(mqttAndroidClient,subscribe.getSubscribeeID().getStudentID(),1);
                                    ...
                                    try {
                                        ...
                                        if (success.equals("1")) {
                                            ...
                                            if(NotificationService.client != null){
                                                NotificationService.client.unsubscribe(subscribe.getSubscribeeID().getStudentID());
                                            }
                                            //pahoMqttClient.unSubscribe(mqttAndroidClient,subscribe.getSubscribeeID().getStudentID());
                                        } else {
                                            Toast.makeText(getActivity().getApplicationContext(), "Error.", Toast.LENGTH_LONG).show();
                                        }
                                    } catch (JSONException e) {
